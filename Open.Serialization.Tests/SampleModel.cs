...
{
	public static readonly IReadOnlyList<decimal?> DecimalList = new decimal?[] { 3.45678m, 45.6789m, null };
	...
	public static readonly SampleModel Instance = new() { Child = new SampleModel() };
}
